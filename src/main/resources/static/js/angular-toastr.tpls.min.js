!function () {
    ...
    function t(t, e, s, n, o, r, a) {
        ...
        function l(t) {
            if (1 !== arguments.length || t)if (t) m(t.toastId); else for (var e = 0; e < w.length; e++)m(w[e].toastId)
        }
        ...
        function f(t, e, s, n) {
            return angular.isObject(s) && (n = s, s = null), C({iconClass: t, message: e, optionsOverride: n, title: s})
        }
        ...
        function C(s) {
            ...
            function l() {
                ...
                var e = {toastId: T++, isOpened: !1, scope: n.$new(), open: a.defer()};
            ...
            function p() {
                var t = g.preventDuplicates && s.message === B, e = g.preventOpenDuplicates && x[s.message];
            ...
            if (!p()) {
                var d = l();
                if (w.push(d), r())for (var f = w.slice(0, w.length - g.maxOpened), C = 0, $ = f.length; C < $; C++)m(f[C].toastId);
    ...
    function t(t, e, s, n) {
        function o(s, o, r, a) {
            ...
            if (s.toastClass = s.options.toastClass, s.titleClass = s.options.titleClass, s.messageClass = s.options.messageClass, s.progressBar = s.options.progressBar, c()) {
                var p = angular.element(s.options.closeHtml), g = t.get("$compile");
